...
তুমি react এর জন্য রেডি কিনা, বোঝা যাবে আজকে (মডিউল ৪২)

#module_release #browser_debug_milestone #module_42
...
আজকের ৯টা ভিডিও একটু বেশিই স্পেশাল এবং এতে আগের টপিকগুলোই আবার রিভিশন দেয়ার জন্য দেয়া হয়েছে ।জাভাস্ক্রিপ্ট এর একজন জুনিয়র ডেভেলপার হওয়ার জন্য যা যা লাগে সেগুলোর একটা লিষ্ট এর মতো করে দিয়েছি যাতে এই টপিকগুলো দেখে তুমি নিজেও বুঝতে পারো। 
